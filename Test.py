...
print("\n*Basic configuration*\n")
hostname = input("Enter the desired hostname: ") # It is strongly advised that you use a strong password.
            ...
            if routing == "yes":
                ...
                for value in routingList:
                    ...
                    for area in value["areas"]:
                        routingConfiguration = routingConfiguration + "network " + area["networkAddress"] + wildCardMask["wildCardMask"]
